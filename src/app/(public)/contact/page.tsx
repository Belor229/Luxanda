          ...
          <div>
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-2.5 rounded-xl font-bold transition-colors text-sm min-h-[44px]"
              >
            ...
            <div className="mt-4 flex items-center gap-2 text-gray-500">
              ...
              <p className="text-sm font-medium">Support disponible — Réponse sous 24h</p>
            </div>
          </div>
